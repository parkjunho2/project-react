...
const Login = () => {
    ...
    // useCallback
    // Handler
    const InputJoinChange = useCallback(
        (e) => {
            setJoinData({
                ...joinData,
    ...
    const dismissModal = isAllValid(validation, excludedKeys)
        ? 'modal'
        : undefined;
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <div className="form-floating form-outline mb-3 upmove-text-hover col-12">
                            <input
                                ...
                                placeholder="아이디" //floating label적용하기 위해 사용
                        ...
                        <div className="form-floating form-outline mb-3 upmove-text-hover col-12">
                            <input
                                ...
                                id="formPassword"
                                className="form-control form-control-lg"
                                placeholder="비밀번호" //floating label적용하기 위해 사용
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <NavLink to="/findPw" className="text-body findPw">
                                비밀번호 찾기
                            </NavLink>
                        </div>
                        ...
                        <div className="modal-body">
                            {userType === 'MEMBER' ? (
                                <div className="shadow-sm p-3 bg-body rounded border">
                                    ...
                                    <div
                                        className={`page ${
                                            currentPage !== 0 ? 'd-none' : ''
                                        }`}
                                    >
                                        {' '}
                                        {/* 변경 사항: currentPage에 따라 클래스 적용 */}
                                        <big>아이디</big>
                                        ...
                                        <div className="input-group has-validation mb-5">
                                            ...
                                            >
                                                ...
                                                />
                                                <label htmlFor="floatingPasswordCheck">
                                                    패스워드 확인
                                                </label>
                                                <span
                                                    className="position-absolute"
                                    ...
                                    >
                                        ...
                                        <div className="form-text text-muted mb-4">
                                            영문 이름은 2~10자 이내의 영어만
                                            허용되며 First LastName 형식만
                                            허용됩니다.
                                        </div>
                                        <big>전화 번호</big>
                                        <div className="input-group has-validation">
