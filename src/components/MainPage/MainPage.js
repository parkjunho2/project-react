...
const MainPage = () => {
    ...
    useEffect(() => {
        ...
        if (!modalClosedTime || currentTime - modalClosedTime > 24 * 60 * 60 * 1000) {
          ...
          <div className="modal-dialog" style={{ marginTop: '100px' }}>
            <div className="modal-content">
              ...
              <div className="modal-body">
                <h5>
                해당 플랫폼은 학습 목적에 맞춰 다양한 시스템과 프로세스를 체험할 수 있는 공간이며, 
                <span style={{ color: 'red' }}>실제 결제나 예약과는 무관합니다.</span> 
                사이트 내 모든 내용은 가상의 데이터로 운영되고 있음을 안내드립니다.
                </h5>
                <div>
                <hr/>
                <h5>로그인 정보</h5>
                <div>
                항공사1 : koreaair / Koreaair1! 
                </div>
                <div>
                항공사2 : asiana / Asiana1!
                </div>
                ...
                <div>
                회원1 : testuser1 / Testuser1!
                </div>
                <div>
                회원1 : testuser2 / Testuser2!
                </div>
                <div className="d-flex justify-content-between">
                <div>
                    관리자1 : admin / Admin1234!
                </div>
                <div className='mx-3'>
                    <strong>
                    관련문의 footer 확인
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" onClick={handleDontShowAgain}>
                하루동안 닫기
                </button>
                ...
                <div className="container">
                    ...
                    <div className="flight-all-div">   {/* 전체 기능에 대한 div */}
                        <div className="flight-search-check row mt-4 mb-4" style={{ marginLeft: "7rem" }}>    {/* 안쪽 여백을 위한 div(전체 기능을 감싸는) */}
                            <h3 className="text-white mb-4 sparkle-move-text">항공권 조회를 한 번에!</h3>
            ...
            <div className="container">
                <div className="container marketing">
                    ...
                    <div className="row">
                        <div className="col">
                            <h3 className="mb-3">TopGun에서 추천하는 여행지 <p className="upmove-text">✈️</p> 
                            </h3>
                        </div>
                    </div>
