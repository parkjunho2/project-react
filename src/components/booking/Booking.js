...
const Booking = () => {
  ...
  const [seatsCountList, setSeatsCountList] = useState([]);
  ...
  useEffect(() => {
    ...
    const isAuthenticated = window.sessionStorage.getItem('refreshToken')|| window.localStorage.getItem('refreshToken');
                            ...
                            <div className="col-md-3 booking-time"  style={{width:"50%"}}>
                              ...
                              {/* <span className="lowest-price">최저가</span> */}
                                ...
                                <div className="d-flex mt-4 ms-3" style={{ display: "flex", justifyContent: "space-between" }}>
                                  ...
                                  {seatsCountList.map((seats) => {
                                  return <span key={seats.flightId}>예약 가능좌석:{seats.unusedSeatsCount} / 총 좌석수:{seats.totalSeatsNo}</span>
                                })}
                      ...
                      <div className="flight-bottom-price row mt-4">
                            <div className="d-flex" style={{ width: "100%", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                <div className="d-flex align-items-center">
                                   ...
                                   <NavLink to={isAuthenticated ? `/payment/${flightId}` : '/login'}>
